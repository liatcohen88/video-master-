...
import { FileText, Sparkles, Mic, Flame, Check, Coins } from "lucide-react";
...
const ORDER: EditMode[] = ["subtitles_only", "basic_effects", "podcast", "advanced_effects"];
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isSelected
                  ? "border-brand bg-bg-card shadow-xl shadow-brand/20 scale-[1.02]"
            ...
            >
              ...
              {/* Credit cost — hero element of the card */}
              <div className="inline-flex items-center gap-1.5 bg-gradient-to-r from-yellow-400/20 to-amber-500/10 border border-yellow-400/40 text-yellow-200 text-sm font-bold px-3 py-1.5 rounded-xl mb-3">
                <Coins className="w-4 h-4" />
                <span className="text-base font-black">{t.cost}</span>
                <span className="text-[11px] font-normal">קרדיטים לסרטון</span>
              </div>
