...
export default function WhatsAppBubble() {
  ...
  return (
    ...
    >
      ...
      {/* The button — static, no pulse/movement (Liat: "ללא פעימה ... מפריע
          בעין"), and a touch smaller. Only a subtle color change on hover. */}
      <span className="w-11 h-11 rounded-full bg-[#25D366] hover:bg-[#1ebe5d] flex items-center justify-center shadow-lg shadow-black/30 transition-colors">
