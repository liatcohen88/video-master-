...
export const CONTENT_DEFAULTS = {
  ...
  "home.heroSubtitle": "מעלים סרטון, ה-AI יוצר כתוביות, אפקטים, וסאונד אוטומטית",
  "home.uploadCta": "להעלאת סרטון",
  "home.multiCardTitle": "מולטי-וידאו AI Editor",
  "home.multiCardDesc": "מעלים כמה סרטונים + מדביקים תסריט. ה-AI יחתוך, יבחר ויאחד לסרטון אחד.",
  "home.multiCardBadge": "✨ חדש",

  // ── Mode picker section header ─────────────────────────────
  "mode.sectionTitle": "איך AI יערוך לך את הסרטון?",
  "mode.sectionSubtitle": "בוחרים סגנון — אחרי התמלול ניתן לעצב את הכתוביות מתוך 10+ תבניות",
  ...
  "landing.feat4.body":  "אנימציות כתוביות ויראליות, אפקטי דרמה ו-WOW, אמוג'ים ולוגו מותגים, ו-65 צלילים — הכל בלחיצה.",
  ...
  "legal.privacyBody":
    ...
    "אנו משתמשים ב-Google Analytics כדי להבין כיצד משתמשים באתר (נתונים מצטברים ואנונימיים) — " +
    "שירות זה עושה שימוש בעוגיות. איננו מוכרים מידע אישי, איננו מציגים פרסומות, ואיננו משתפים מידע לצורכי פרסום.",
  ...
  // Login
  "auth.login.heading":         "ברוכים השבים",
  "auth.login.subheading":      "כניסה לחשבון",
  "auth.login.submit":          "התחברות",
  "auth.login.submitBusy":      "מתחבר...",
  "auth.login.noAccount":       "אין לכם חשבון?",
  "auth.login.signupCta":       "להרשמה",
  // Signup
  ...
  "auth.signup.submitBusy":     "יוצר חשבון...",
  "auth.signup.terms":          "בלחיצה על \"יצירת חשבון\" אני מסכים/ה ל-",
  "auth.signup.haveAccount":    "כבר יש לכם חשבון?",
  "auth.signup.loginCta":       "התחברות",
  "auth.signup.confirmTitle":   "כמעט שם! 🎉",
  "auth.signup.confirmBody":    "נשלח אימייל אישור ל-{{email}}. יש ללחוץ על הקישור במייל כדי להפעיל את החשבון.",
  "auth.signup.confirmCta":     "חזרה להתחברות",
  "auth.login.forgot":          "שכחתם סיסמה?",
  ...
  "auth.welcome.ctaUpload":     "להעלות סרטון",
  ...
  "credits.insufficient.title":      "אין מספיק מאסטרים 😅",
  "credits.insufficient.body":       "לייצוא הסרטון צריך {{need}} מאסטרים, וביתרה יש {{have}}. אפשר לקנות עוד מאסטרים או לחזור לעריכה ולהסיר אפקטים כדי להוזיל.",
  "credits.insufficient.ctaBuy":     "לקניית מאסטרים",
  "credits.insufficient.ctaBuyHref": "/credits",
  "credits.insufficient.ctaBack":    "חזרה לעריכה",

  // ── Forgot password (/forgot-password) ─────────────────────
  "auth.forgot.heading":        "איפוס סיסמה",
  "auth.forgot.subheading":     "נשלח קישור איפוס למייל",
  "auth.forgot.submit":         "לשליחת קישור איפוס",
  "auth.forgot.submitBusy":     "שולח...",
  "auth.forgot.sentTitle":      "נשלח! ✨",
  "auth.forgot.sentBody":       "נשלח קישור איפוס ל-{{email}}. יש לבדוק את התיבה וללחוץ על הקישור.",
  "auth.forgot.backToLogin":    "חזרה להתחברות",

  // ── Credits / pricing page (/credits) ─────────────────────
  "credits.eyebrow":         "חבילות מאסטרים",
  "credits.title":           "לבחור את הקצב המתאים",
  ...
  "credits.guestGift":       "הירשמו בכדי לנצל את ה-25 מאסטרים שקיבלתם מאיתנו 🎁",
  ...
  "credits.modes.subtitles_only.desc": "תמלול + תבניות + אנימציית כתוביות",
  "credits.modes.podcast.name":        "פודקאסט",
  "credits.modes.podcast.desc":        "+ חיתוך שתיקות + אמוג'ים + לוגו + סאונד",
  "credits.modes.advanced.name":       "אפקטים מתקדמים",
  "credits.modes.advanced.desc":       "הכל — דרמה, WOW, אמוג'ים, מותגים, סאונד",
  ...
  "account.password.submit":      "עדכון סיסמה",
  "account.password.submitBusy":  "מעדכן...",
  "account.password.ok":          "✓ הסיסמה עודכנה בהצלחה",
  "account.export.title":         "הורדת הנתונים שלי",
  "account.export.hint":          "קובץ JSON עם הפרופיל וההגדרות — לשמור או להעביר",
  "account.export.button":        "להורדת קובץ",
  "account.danger.title":         "מחיקת חשבון",
  "account.danger.hint":          "מוחק את החשבון, היתרה והפרופיל — לצמיתות. אין דרך חזרה.",
  "account.danger.button":        "למחיקת החשבון",
  "account.danger.busy":          "מוחק...",
  "account.danger.confirm":       "לאשר מחיקה? הפעולה הזו תמחק את החשבון, היתרה והפרופיל לצמיתות. אין דרך חזרה.",
  ...
  "emails.reset.body":           "היי,\n\nיש ללחוץ על הקישור הבא לאיפוס הסיסמה (תקף לשעה):\n{{link}}\n\nאם לא ביקשתם איפוס — אפשר להתעלם מהמייל הזה.\n\nMaster Video",
  ...
  "help.emptyResults":     "לא נמצאו תשובות. אפשר לנסות מילים אחרות או ליצור קשר במייל.",
  "help.contactCard.title":"לא מצאת תשובה?",
  "help.contactCard.body": "ליצירת קשר — נחזור אליכם תוך 24 שעות",
  "help.contactCard.cta":  "ליצירת קשר",
  ...
  "dashboard.snapshots.empty.hasVideo":"יש סרטון שמור. אפשר להתחיל לערוך — גרסאות יישמרו אוטומטית כל 5 דקות.",
  ...
  "multi.error.scriptRequired":    "יש להדביק תסריט",
  ...
  "multi.assign.help":          "לוחצים על תמונה כדי לשנות איזה סרטון מופיע בכל שורה. הסרטון יתעדכן מיד.",
  "multi.assign.videoLabelTpl": "סרטון {{n}}",

  // ── StylePanel (subtitle styling editor) ─────────────
  "style.heading":             "עריכת הסרטון",
  "style.notSelected":         "לא נבחר",
  "style.section.subtitleStyle":"סגנון כתוביות",
  "style.section.extras":      "אפקטים נוספים",
  "style.section.typography":  "טיפוגרפיה",
  "style.section.colors":      "צבעים",
  "style.section.background":  "רקע",
  "style.section.position":    "מיקום",
  "style.previewText":         "שלום",
  "style.extras.priceNote":    "{{summary}} · כל אפקט מוסיף 2-3 מאסטרים",
  "style.extras.help":         "💡 <strong>תוספת אופציונלית</strong> — ה-AI לא מפעיל אותם אוטומטית. אפשר לבחור בכל אחד מהם, ולשלם רק עבור מה שנבחר. המחיר מתעדכן בזמן אמת על כפתור הייצוא.",
  "style.field.font":          "פונט",
  "style.field.size":          "גודל: {{px}}px",
  "style.field.weight":        "עובי",
  "style.weight.regular":      "רגיל",
  "style.weight.semibold":     "סמיבולד",
  "style.weight.bold":         "בולד",
  "style.weight.black":        "שחור",
  "style.field.color":         "צבע הטקסט",
  "style.field.stroke":        "צבע הקו (Stroke)",
  "style.field.strokeWidth":   "עובי קו: {{px}}px",
  "style.field.highlightColor":"צבע הדגשה (מילה פעילה)",
  "style.hint.highlightSame":  "טיפ: צבע זהה לצבע הטקסט = ללא הדגשה",
  "style.bg.none":             "ללא",
  "style.field.bgColor":       "צבע רקע",
  "style.field.bgOpacity":     "שקיפות רקע: {{pct}}%",
  "style.field.verticalPos":   "מיקום אנכי",
  "style.position.top":        "למעלה",
  "style.position.middle":     "אמצע",
  "style.position.bottom":     "למטה",
  "style.field.offset":        "היסט: {{px}}px",
  "style.field.align":         "יישור טקסט",
  "style.align.right":         "ימין",
  "style.align.center":        "מרכז",
  "style.align.left":          "שמאל",
  "style.summary.cutSilence":  "חיתוך שתיקות",
  ...
  "editor.empty":                "עוד אין כתוביות. צריך להעלות וידאו ולתמלל כדי להתחיל.",
  "editor.sfx.disabled":         "סאונד אפקט מבוטל",
  "editor.sfx.currentTpl":       "סאונד אפקט: {{label}}",
  ...
  "editor.sfx.none":             "ללא סאונד אפקט",
  ...
  "resume.title":            "להמשיך עריכה מאיפה שהפסקתם",
  "resume.descriptionTpl":   "הסרטון נשמר אצלנו ({{name}} • {{mb}} MB)",
  "resume.savedAtTpl":       "נשמר {{age}}",
  "resume.cta.continue":     "▶ המשך עריכה",
  "resume.previousVersionsTpl":"גרסאות קודמות ({{n}})",
  "resume.cta.discard":      "מחיקת השמור",
  ...
  "aiLoader.stayWarning":    "⚠️ חשוב להישאר בדף ולא לעבור לטאב אחר — סגירה תבטל את התהליך.",
  ...
  "effects.bgMusic.uploadHint":       "מעלים קובץ MP3 / WAV / OGG — הוא יתנגן ברקע ויסונכרן עם הנגינה והעצירה של הסרטון.",
  ...
  "effects.bgMusic.balanceTip":       "טיפ: כדאי להשאיר את המוזיקה ב-15-30% — הקול חייב להוביל.",
  ...
  "effects.logo.emptyHelpPersonalBody":"בקרות גודל (S/M/L + PX) ומיקום (4 פינות) יופיעו אחרי העלאת לוגו ☝️",
  ...
  "effects.intro.hint":          "האנימציה רצה רק בשנייה הראשונה. אפשר לאפשר לנגן את התצוגה מהתחלה כדי לראות.",
  ...
  "signupGate.error.emailExists": "האימייל כבר רשום. אפשר לעבור להתחברות 👇",
  "signupGate.notice.confirmEmail":"נשלח אימייל אישור — אחרי האישור אפשר לחזור ולהוריד.",
  ...
  "aiPanel.brands.unmatched.hint":"כדאי לערוך את הכתוביות אם השם נכתב אחרת ממה שנאמר בסרטון.",
  ...
  "help.faqs": [
    ...
    { cat: "general",  q: "האם זה באמת חינמי?",
      a: "כן — הגרסה הבסיסית. כתוביות בלבד = 10 מאסטרים, פודקאסט = 20, אפקטים מתקדמים = 25-40. כל משתמש חדש מקבל 25 מאסטרים מתנה (כ-2-3 סרטונים לטעימה)." },
    ...
    { cat: "general",  q: "מה ההבדל בין המצבים?",
      a: "כתוביות בלבד = תמלול + עיצוב, בלי שינוי בוידאו. פודקאסט = חיתוך שתיקות + אמוג'ים + לוגו + סאונד. אפקטים מתקדמים = הכל — דרמה, WOW, אמוג'ים, מותגים וסאונד." },
    { cat: "credits", q: "מה זה מאסטרים?",
      a: "מאסטרים זה המטבע הפנימי שלנו 🪙 — קונים חבילה (לדוגמה 50 מאסטרים ב-₪25) ומשתמשים בהם לעריכת סרטונים. ככה משלמים רק עבור מה שבאמת בשימוש, בלי מנוי חודשי שגובה כסף גם בלי עריכה." },
    { cat: "credits", q: "כמה עולה סרטון?",
      a: "תלוי במצב: כתוביות בלבד = 10 מאסטרים (קבוע), פודקאסט = 20 (קבוע), חיבור סרטונים = 20 (קבוע). אפקטים מתקדמים הם דינמיים — מתחיל ב-25 וכל אפקט שמפעילים מוסיף 2-3 מאסטרים, עד תקרה של 40. ייצוא כתוביות בלבד לפרמייר (קובץ SRT) = 10 מאסטרים. ככה משלמים רק עבור מה שבאמת בשימוש. ניתן לראות את העלות העדכנית על כפתור הייצוא בזמן אמת." },
    { cat: "credits", q: "האם הקרדיט פג?",
      a: "לא — הקרדיט תקף לתמיד. אין חידוש אוטומטי. משלמים רק כשרוצים לקנות עוד." },
    ...
    { cat: "credits", q: "אפשר לקבל החזר?",
      a: "כן — בתוך 14 ימים אם הקרדיט לא נוצל. ליצירת קשר במייל ונחזיר את התשלום." },
    { cat: "export",  q: "באיזה פורמט הסרטון יורד?",
      a: "בוחרים בסיום העריכה, בין שני כפתורי הייצוא: וידאו MP4 ברזולוציה המקורית (מחיר לפי האפקטים שנבחרו), או קובץ כתוביות SRT לפרמייר/דיוינצ'י (10 מאסטרים). אין צורך להחליט מראש — עורכים פעם אחת ואז מחליטים איך להוריד." },
    ...
    { cat: "export",  q: "הסרטון יוצא חתוך / לא במיקום הנכון",
      a: "יש לוודא שהאספקט (יחס תצוגה) נכון — בדרך כלל 'מקורי' עובד הכי טוב. אם נבחר 9:16 אבל הסרטון מקורי 16:9, הוא יחתוך אוטומטית למרכז." },
    { cat: "export",  q: "האם הכתוביות נשמרות?",
      a: "כן — האפליקציה שומרת אוטומטית את כל ההגדרות שלך (כתוביות, סגנון, אפקטים) ב-localStorage. ברענון ממשיכים מאיפה שהפסיקו. רק את הוידאו עצמו צריך להעלות שוב." },
    { cat: "problems", q: "התמלול שגוי / חסר מילים",
      a: "יש לוודא שנבחר מודל 'עברית מקצועי'. אם הוידאו רועש או הדובר רחוק מהמיקרופון, אפשר לערוך את הכתוביות ידנית בלשונית 'עורך כתוביות'." },
    { cat: "problems", q: "הייצוא תקוע / לא מסתיים",
      a: "ייצוא ארוך (3+ דקות) במחשבים עם זיכרון נמוך עלול להיתקע. כדאי לסגור טאבים אחרים ולנסות שוב. אם זה חוזר — אפשר לנסות מצב 'כתוביות בלבד' שצורך פחות זיכרון." },
    ...
    { cat: "problems", q: "ה-SFX לא נשמע בייצוא",
      a: "יש לוודא ש'אפקטי SFX' מופעלים בלשונית האפקטים. הצליל מתנגן רק כשיש אלמנט (אמוג'י/לוגו/אפקט) עם המילה המתאימה." },
    ...
    { cat: "advanced", q: "איך מוסיפים אמוג'י / לוגו מותג / אפקט לכתובית?",
      a: "בעורך הכתוביות, לחיצה על כפתור ✨ ליד כל משפט. בדיאלוג שנפתח יש 4 לשוניות: אמוג'ים (עם חיפוש בעברית), לוגו מותגים (אינסטגרם, טסלה ועוד), דרמה (הבזק שחור-לבן), ו-WOW (חלקיקים + רעידה + זום) — כולם עם בקרת גודל, מיקום ומשך." },
    { cat: "advanced", q: "אפשר להוסיף צליל לאמוג'י?",
      a: "כן! בעורך הכתוביות, ליד כל אמוג'י או אלמנט שמוסיפים יש אייקון רמקול 🔊. לחיצה פותחת בוחר עם 65 צלילי SFX (קליקים, וושש, מטבעות, ויראלי...) ניתן לבחור צליל או 'ללא צליל'." },
  ...
  "home.toast.resumeHint":  "להמשיך מהנקודה האחרונה — להעלות את הסרטון לעריכה",
  "home.toast.videoLoaded": "הסרטון נטען — אפשר להתחיל לתמלל",
  ...
  "signupGate.submitNew":     "ליצירת חשבון והורדה",
  "signupGate.submitIn":      "להתחברות והורדה",
  "signupGate.switchToLogin": "כבר יש חשבון? להתחברות",
  "signupGate.switchToSignup":"עוד אין חשבון? להרשמה",
  ...
  "purchase.cta.start": "להתחיל לערוך",
  "purchase.cta.more":  "לרכישת חבילה נוספת",
  ...
  "uploader.dropTitle":    "בחירת הסרטון שה-AI יערוך עבורך",
  ...
  "glossary.brands.body":
    "כשמזכירים מותג בכתוביות, ה-AI ממקם את הלוגו אוטומטית בפינת המסך — בלי צורך להעלות אותו ידנית.",
  "glossary.drama.title":    "🎬 מילות דרמה (שחור-לבן + סטינג)",
  "glossary.drama.body":
    "ברגע שאחת מהמילים הבאות מופיעה — המסך הופך לשחור-לבן ל-1.2 שניות ונוסף צליל סטינג דרמטי.",
  "glossary.wow.title":      "🤩 מילות וואו (פעימה + חלקיקים)",
  "glossary.wow.body":
    "מילים של התלהבות חיובית — ברגע שמופיעות, יש פעימת זום קצרה + פרץ חלקיקים.",
  "glossary.elements.title": "✨ מילים שמזמינות אמוגי",
  "glossary.elements.body":
    "ה-AI מזהה מילה (כסף, מסיבה, אהבה...) ומוסיף אמוגי וסאונד אפקט.",
