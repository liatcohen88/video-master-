...
export const CONTENT_DEFAULTS = {
  ...
  "help.faqs": [
    ...
    { cat: "credits", q: "כמה עולה סרטון?",
      a: "תלוי במצב: כתוביות בלבד = 10 מאסטרים (קבוע), פודקאסט = 20 (קבוע), חיבור סרטונים = 20 (קבוע). אפקטים מתקדמים הם דינמיים — מתחיל ב-25 וכל אפקט שמפעילים מוסיף 2-3 מאסטרים, עד תקרה של 40. ככה משלמים רק עבור מה שבאמת בשימוש. ניתן לראות את העלות העדכנית על כפתור הייצוא בזמן אמת." },
    ...
    { cat: "export",  q: "באיזה פורמט הסרטון יורד?",
      a: "MP4 ברזולוציה המקורית של הסרטון שהועלה, או SRT (כתוביות בלבד לפרמייר/דיוינצ'י). ניתן לבחור בלשונית 'ייצוא'." },
