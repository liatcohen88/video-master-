...
export const CONTENT_DEFAULTS = {
  ...
  "help.faqs": [
    ...
    { cat: "problems", q: "ה-SFX לא נשמע בייצוא",
      a: "ודאי ש'אפקטי SFX' מופעלים בלשונית האפקטים. הצליל מתנגן רק כשיש אלמנט (אמוג'י/לוגו/אפקט) עם המילה המתאימה." },
  ...
  "home.toast.resumeHint":  "המשך מהנקודה האחרונה — להעלות את הסרטון לעריכה",
