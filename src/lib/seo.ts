...
export const SITE = {
  ...
  description:
    "פלטפורמת AI לעריכת וידאו בעברית — תמלול מקצועי, עיצוב כתוביות לרילס " +
    "וטיקטוק, אפקטים אוטומטיים וייצוא MP4 מוכן לעלייה. 25 מאסטרים מתנה להתנסות.",
  locale:     "he_IL",
  language:   "he",
...
export function softwareJsonLd() {
  return {
    ...
    offers: {
      ...
      price: "0",
      priceCurrency: "ILS",
      description: "25 מאסטרים מתנה להתנסות; חבילות בתשלום מ-₪10",
    },
    featureList: [
      "תמלול עברית אוטומטי",
